...
SIZE_MAPPING = {0: "COMMON", 1: "SKINNY", 2: "BIG BOI"}
ACCESSORY_MAPPING = {
    0: "RAT",
    1: "LEAN",
    2: "CHEF",
...
def get_size(size_number):
    return SIZE_MAPPING[size_number]


def get_accessory(accessory_number):
    return ACCESSORY_MAPPING[accessory_number]
